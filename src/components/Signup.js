  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:5000/student/signup', {
     ...
     .then(data => {
        console.log(data);
        if (data.success) {
          props.showAlert('success','Registration Successful');
          setCredentials({ name: "", email: "", mobile: "", address: "", password: "" });
          navigate('/login');
    ...
    <div className='container my-4'>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input onChange={onChange} type="text" className="form-control" id="mobile" name="mobile" />
